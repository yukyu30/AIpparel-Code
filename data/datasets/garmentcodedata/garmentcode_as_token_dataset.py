...
extra_pkgs = "{}/external".format(currentdir)
...
from garmentcodedata.external.customconfig import Properties
...
class GarmentCodeData(Dataset):  
    def __init__(self, root_dir, gt_caching=True, feature_caching= True, caching=True, info=False,
        ...
        self.rot_type = start_config['rot_type']
        self.as_vertices = start_config['as_vertices']
    ...
    def __getitem__(self, idx):
        ...
        if self.as_vertices and self.ready:
            v = self._as_vertices(sample['ground_truth']['outlines'], sample['ground_truth']['num_edges'])
            sample['ground_truth']['vertices'] = v
