...
@dataclass 
class AIpparelConfig():
    use_mm_start_end: bool = True


class AIpparelModel(AIpparelMetaModel, LlavaLlamaModel):
    def __init__(
        self,
        config,
        **kwargs
    ):
        super(AIpparelModel, self).__init__(config, **kwargs)
...
class AIpparelForCausalLM(LlavaLlamaForCausalLM):
    def __init__(
        self,
        config: LlamaConfig,
        **kwargs,
        ...
        self.model = AIpparelModel(config, **kwargs)
