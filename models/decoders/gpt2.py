...
class GPT(nn.Module):
    ...
    def __init__(self, block_size: int, vocab_size: int, n_layer: int, n_head: int, n_embd: int, encoder: Literal["gpt2"], ignore_index: Optional[int] = None):
        super().__init__()
        ...
        self.transformer = nn.ModuleDict(dict(
            ...
            h = nn.ModuleList([Block(n_embd, n_head) for _ in range(self.n_layer)]),
