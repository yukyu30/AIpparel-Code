...
CUDA_VISIBLE_DEVICES=3,4 \
    ...
    experiment.run_name=garmentcodedata.llava-7b.regression.r8.kv.lr6e-4.pos.sinusoidal_0.multimodal.eval.image_text \
    ...
    hydra.run.dir=/miele/george/garment/sewformer/outputs/eval_image_text \
