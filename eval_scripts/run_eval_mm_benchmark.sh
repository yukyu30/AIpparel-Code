...
CUDA_VISIBLE_DEVICES=5,7 \
    ...
    experiment.run_name=garmentcodedata.llava-7b.regression.r8.kv.lr6e-4.pos.sinusoidal_0.multimodal.eval.mm_benchmark \
    trainer.steps_per_epoch=750 \
    trainer.epoches=20 \
    data_wrapper.data_split.load_from_split_file=/home/w4756677/garment/garment_foundation_model/sewformer/SewFormer/assets/data_configs/multi_modal_benchmark_datasplit.json \
    ...
    data_wrapper/dataset=garment_mm_benchmark \
    data_wrapper/dataset/garment_tokenizer/standardize=garmentcodedata_regression_stats \
    hydra.run.dir=/miele/george/garment/sewformer/outputs/mm_benchmark3 \
